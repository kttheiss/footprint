class ActivitiesController < ApplicationController
  before_action :current_user_must_be_activity_user,
  ...
  def index
    ...
    @activities = @q.result(distinct: true).includes(:user, :category,
  ...
  def activity_params
    params.require(:activity).permit(:date, :name, :category_id, :user_id,
